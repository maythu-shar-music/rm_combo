...
headers = {
    ...
    data = 'type=card&billing_details[name]=Kai+Jas&card[number]={n}&card[cvc]={cvc}&card[exp_month]={mm}&card[exp_year]={yy}&guid=NA&muid=NA&sid=NA&payment_user_agent=stripe.js%2Fdda83de495%3B+stripe-js-v3%2Fdda83de495%3B+card-element&key=pk_live_X8I5Jg4Cf3h2FfLSP7fZ2JwS'
